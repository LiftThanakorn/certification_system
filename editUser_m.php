                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form id="editProfileForm" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <label for="executiveposition" class="form-label">วิทยฐานะสายสนับสนุน: </label>
        ...
        $('#editProfileForm').submit(function(event) {
            ...
            if (password !== confirmPassword) {
                Swal.fire({
                    ...
                    text: 'รหัสผ่านและยืนยันรหัสผ่านใหม่ไม่ตรงกัน',
            ...
            $.ajax({
                ...
                type: 'POST',
                data: formData,
                dataType: 'text', // Change this to 'text'
                processData: false,
                contentType: false,
                success: function(response) {
                    ...
                    try {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'เกิดข้อผิดพลาด!',
                            text: 'ข้อมูลที่รับคือ JSON ไม่ถูกต้อง',
                            confirmButtonText: 'ตกลง'
                        });
                    }
                },
